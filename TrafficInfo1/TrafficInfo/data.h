...
//***********************************************控制状态查询表**********************************************************
class ControlState : public AbstractDataType
{
public:
	//路口ID
	string CrossingId;
	...
	ControlState::ControlState(string crossing_id, string stream_index, string road_in_id, string road_out_id, string pri)
	{
		CrossingId = crossing_id;
	...
	string getDataString()
	{
		return "('" + CrossingId + "','" + StreamIndex  + "','" + RoadInId + "','" + RoadOutId + "','" + Priority + "')";
	}
};
//********************************************检测器表************************************************
...
public:
	...
	PhaseStream::PhaseStream(string phase_index, string stream_index, string pri, string dir_flag, string phase_id, string plan_index, string crossing_index, string link_in_id, string link_out_id)
	{
	...
	string getDataString()
	{
		return "('" + PhaseIndex + "','" + StreamIndex + "','" + Priority + "','" + DirectionFlag + "','" + PhaseId + "','" + PlanIndex + "','" + CrossingId + "','" + LinkInId + "','" + LinkOutId + "')";
	}
};
